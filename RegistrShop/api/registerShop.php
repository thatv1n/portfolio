...
$result = $mysqli->query("INSERT INTO `SHOPS` (`id`, `name`, `discount_type`, `cashback`, `image`, `adres`, `phone`, `comment`, `opisanie`, `etiketka_height`, `etiketka_code`, `check_top`, `check_bottom`, `datecreate`, `data_oplaty`, `multiAccount`, `chat_id`, `balans`, `e_mail`, `social_net`, `dolg`) VALUES (NULL, '$nameShop', '', '0', '', '$address', '$phoneShop', '$commentShop', '', '0', 'code128', '', '', CURRENT_TIMESTAMP, '', '', '', '', '', '', '');");
