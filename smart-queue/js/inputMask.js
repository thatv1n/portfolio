(function (global, factory) {
  ...
  var stringPadWebkitBug = /Version\/10(?:\.\d+){1,2}(?: [\w./]+)?(?: Mobile\/\w+)? Safari\//.test(
    userAgent,
  );
  ...
  var MaskedRange = /*#__PURE__*/ (function (_MaskedPattern) {
    ...
    _createClass(MaskedRange, [
      ...
      },
      {
        ...
        get: function get() {
          return (
            _get(_getPrototypeOf(MaskedRange.prototype), 'isComplete', this) && Boolean(this.value)
          );
        },
      },
      {
    ...
    _createClass(MaskedNumber, [
      ...
      },
      {
        ...
        value: function doPrepare(ch) {
          ...
          var _normalizePrepare = normalizePrepare(
              (_get2 = _get(_getPrototypeOf(MaskedNumber.prototype), 'doPrepare', this)).call.apply(
                _get2,
                [this, noSepCh].concat(args),
              ),
            ),
    ...
    _createClass(MaskedDynamic, [
      ...
      },
      {
        ...
        value: function doValidate() {
          ...
          return (
            (_get2 = _get(_getPrototypeOf(MaskedDynamic.prototype), 'doValidate', this)).call.apply(
              _get2,
              [this].concat(args),
            ) &&
            (!this.currentMask ||
      ...
      },
      {
        ...
        value: function remove() {
          ...
          if (this.currentMask) {
            ...
            details
              .aggregate(
                (_this$currentMask5 = this.currentMask).remove.apply(_this$currentMask5, arguments),
