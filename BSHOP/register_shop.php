...
<body>
            ...
            <div class="form d-flex align-items-center">
              ...
              <div class="content">
                <form method="post" class="form-validate" method="post" id="form_send">
                  ...
                  <p>Выберите тип магазина</p>
                  <div class="form-group">
                    <input type="radio" id="nakop" name="discount_type" value="1" />
                    <label for="nakop">Накопительная система</label> <br>
                    <input type="radio" id="disk" name="discount_type" value="0" />
                    <label for="disk">Дисконтная система</label>
                  </div>
                  <div class="form-group">
  ...
  <script>
    ...
    $('[name=loginSotr]').bind("change keyup input click", function() {
      if (this.value.match(/[^0-9]/g)) {
        this.value = this.value.replace(/[^0-9]/g, '');
      }
    });

    $('[name=passSotr]').bind("change keyup input click", function() {
      if (this.value.match(/[^0-9]/g)) {
        this.value = this.value.replace(/[^0-9]/g, '');
      }
    });
    ...
    document.getElementById('form_send').onsubmit = (e) => {
      ...
      requestFetch('./api/registerShop.php', {
        ...
        console.log(data);
        if (data != 'Такой логин уже зарегестрирован!') {
          form.reset();
        }
        alert(`${data}`)
        $('.loader').remove();
